...
def get_voucher_number(voucher_type,voucher_no):
    ...
    #     voucher_number = frappe.db.get_value("Stock Entry", {'name':voucher_no},[ "file_number"]) 
    #     if not voucher_number:
    #         voucher_number = voucher_no   
...
def get_customer(voucher_type,voucher_no):
    ...
    if voucher_type == "Delivery Note":
        ...
        customer = frappe.db.get_value("Stock Entry",{'name':voucher_no},[ "customer"]) or "NA"
    else:
        customer  = "NA"
    return customer

def get_territory(voucher_type,voucher_no):
    territory = ''
    if voucher_type == "Delivery Note":
        territory = frappe.db.get_value("Delivery Note",{'name':voucher_no},["territory"])
    else:
        territory = "-"
    return territory
