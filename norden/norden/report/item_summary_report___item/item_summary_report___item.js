...
frappe.query_reports["Item Summary Report - Item"] = {
	"filters": [
		{
			"fieldname": "item",
			"label": __("Item"),
	...
	"formatter": function (value, row, column, data, default_formatter) {
		if (column.fieldname == "item" && data ) {
			value = data["item"];			
			column.link_onclick = "frappe.query_reports['Item Summary Report - Item'].set_route_to_allocation(" + JSON.stringify(data) + ")";
		}
