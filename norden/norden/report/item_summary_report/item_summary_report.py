...
def get_data(filters):
	...
	for i in item:
		...
		if stocks["actual_qty"] > 0:
			row = [i.name,i.item_name,i.item_group,filters.company,stocks["actual_qty"],all_qty or 0,stocks["actual_qty"]-all_qty,mrb_qty or 0,ppoc_total or 0,i.stock_uom]
		else:
			row = [i.name,i.item_name,i.item_group,filters.company,0,all_qty or 0,0,mrb_qty or 0,ppoc_total or 0,i.stock_uom]
		data.append(row)
	return data