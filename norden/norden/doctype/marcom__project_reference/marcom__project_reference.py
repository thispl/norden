...
class MARCOMProjectReference(Document):
	pass

# @frappe.whitelist()
# def create_marcom_reference(doc,method):
# 	pr_id = frappe.db.exists("MARCOM  Project Reference",{'project_name' : doc.project_name})
# 	if pr_id:
# 		pr = frappe.get_doc("MARCOM  Project Reference",pr_id)
# 	else:
# 		pr = frappe.new_doc("MARCOM  Project Reference")
