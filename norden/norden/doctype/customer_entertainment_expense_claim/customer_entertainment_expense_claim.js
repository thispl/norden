...
frappe.ui.form.on('Customer Entertainment Expense Claim', {
    ...
    employee(frm){
        ...
        frm.set_value('hrm_mail_id','hrd@nordencommunication.com')
        frm.set_value('accounts_mail_id','arunkumar.m@nordencommunication.com')
        ...
        if(frm.doc.company == 'Norden Communication Pvt Ltd'){
            frm.set_value('finance_verifier_mail_id','greeshma@nordencommunication.com')
        }
