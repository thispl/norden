...
def get_header(doc):
    data = ''
    data += '<tr><td style="background-color:#7dba33;font-family:Frutiger Bold;" rowspan="2"><svg height="29" width="10"><text font-size="8px" fill="white" transform="translate(10,28) rotate(-90)">MODEL</text></svg></td>'
...
def get_header_test(doc):
    data = ''
    data += '<tr><td style="background-color:#D12421;font-family:Frutiger Bold;" rowspan="2"><svg height="29" width="10"><text font-size="8px" fill="white" transform="translate(10,28) rotate(-90)">MODEL</text></svg></td>'
    data += '<td style="background-color:#E4E4E4;border-bottom: 0.5px solid #FFFFFF;" ><b style="color:#404040;font-family:Frutiger Bold;">Model No.</b></td><td colspan="8" style="background-color:#D12421;color:white;font-family:Frutiger Bold;border-bottom: 0.5px solid #FFFFFF;">%s</td></tr>' % (
        doc.ds_item_no)
    data += '<tr><td style="background-color:#E4E4E4; border-bottom: 0.5px solid #FFFFFF;border-top: 0.5px solid #FFFFFF;">Type</td><td colspan="8" style="border-bottom: 0.5px solid #FFFFFF;border-top: 0.5px solid #FFFFFF;">%s</td></tr>' % (
        doc.ds_item_name)
    return data
...
#                 data += '<tr><td style="background-color:#7dba33;font-family:Frutiger Bold;" rowspan="2"><svg height="28" width="10"><text font-size="8px" fill="white" transform="translate(10,28) rotate(-90)">MODEL</text></svg></td>'
#                 data += '<td style="background-color:#E4E4E4;border-bottom: 0.5px solid #E8E8E8;" ><b style="color:#404040;font-family:Frutiger Bold;">Model No.</b></td><td colspan="8" style="background-color:#7dba33;color:#505050;font-family:Frutiger Bold;border-bottom: 0.5px solid #FFFFFF;">%s</td></tr>' % (
#                     doc.ds_item_no)
#                 data += '<tr><td style="background-color:#E4E4E4; border-bottom: 0.5px solid #E8E8E8;border-top: 0.5px solid #E8E8E8;">Type</td><td colspan="8" style="border-bottom: 0.5px solid #E8E8E8;border-top: 0.5px solid #E8E8E8;">%s</td></tr>' % (
#                     doc.ds_item_name)
...
def get_specification(doc, spec_tables):
    ...
    txtcl2 = "FFFFFF"
    b1 = "#FFFFFF"
    next_spec_available = False
    for i, spec in enumerate(spec_tables):
        spec_len = 0
        if spec[0]:
            spec_len = get_length(spec[0])
            if spec_len > 6:
            ...
            next_spec_available = False
            if i < len(spec_tables) - 1:
                if spec_tables[i + 1][0]:
                    next_spec_available = True
            if spec[2] == 1:
                if spec[0]==doc.ds_general and next_spec_available:
                    data += '</table><p style="page-break-before: always;"></p>'
                    data += '<table class="table-condensed specifictd" style="width:100%">'
                    data += '<tr><td style="background-color:#7dba33;font-family:Frutiger Bold;" rowspan="2"><svg height="29" width="10"><text font-size="8px" fill="white" transform="translate(10,28) rotate(-90)">MODEL</text></svg></td>'
                    data += '<td style="background-color:#C6C6C6;border-bottom: 0.5px solid #E8E8E8;" ><b style="color:#404040;font-family:Frutiger Bold;">Model No.</b></td><td colspan="8" style="background-color:#7dba33;color:#505050;font-family:Frutiger Bold;border-bottom: 0.5px solid #898989;">%s</td></tr>' % (
                        doc.ds_item_no)
                    data += '<tr><td style="background-color:#C6C6C6; border-bottom: 0.5px solid #E8E8E8;border-top: 0.5px solid #E8E8E8;">Type</td><td colspan="8" style="border-bottom: 0.5px solid #E8E8E8;border-top: 0.5px solid #E8E8E8;">%s</td></tr>' % (
                        doc.ds_item_name)
                elif spec[0]!=doc.ds_general:
                    data += '</table><p style="page-break-before: always;"></p>'
                    data += '<table class="table-condensed specifictd" style="width:100%">'
                    data += '<tr><td style="background-color:#7dba33;font-family:Frutiger Bold;" rowspan="2"><svg height="29" width="10"><text font-size="8px" fill="white" transform="translate(10,28) rotate(-90)">MODEL</text></svg></td>'
                    data += '<td style="background-color:#C6C6C6;border-bottom: 0.5px solid #E8E8E8;" ><b style="color:#404040;font-family:Frutiger Bold;">Model No.</b></td><td colspan="8" style="background-color:#7dba33;color:#505050;font-family:Frutiger Bold;border-bottom: 0.5px solid #898989;">%s</td></tr>' % (
...
def get_specification_test(doc, spec_tables):
    ...
    for i, spec in enumerate(spec_tables):
        ...
        if spec[0]:
            ...
            data += '<tr><td style="background-color:#%s;font-family:Frutiger Bold;width:2px;" rowspan="%s"><svg height="%s" width="10px"><text text-align="center" font-weight="bold" font-size="10px" fill=#%s transform="translate(10,%s) rotate(-90)">%s</text></svg></td>' % (
                cl1, len(spec[0]), svg_height, txtcl1, svg_translate, svg_title)
            for s in spec[0]:
                if clr == "1":
                    data += '<td style="background-color:#%s; border: 0.5px solid %s;color:#%s;width:150px">%s</td><td style="border: 0.5px solid #FFF7F9;background-color:#FFF7F9;">%s</td></tr><tr>' % (
                        cl2, b1, txtcl2, s.title, s.specification)
                    clr = "2"
                else:
                    data += '<td style="background-color:#%s; border: 0.5px solid %s;color:#%s">%s</td><td style="border: 0.5px solid #FFF7F9;background-color:#FFFFFF;">%s</td></tr><tr>' % (
                            cl2, b1, txtcl2, s.title, s.specification)
            ...
            if spec[2] == 1:
                if spec[0]==doc.ds_general and next_spec_available:
                    frappe.msgprint("enter this condition")
                    data += '</table><p style="page-break-before: always;"></p>'
                    data += '<table class="table-condensed specifictd" style="width:100%">'
                    data += '<tr><td style="background-color:#D12421;font-family:Frutiger Bold;" rowspan="2"><svg height="29" width="10"><text font-size="8px" fill="white" transform="translate(10,28) rotate(-90)">MODEL</text></svg></td>'
                    data += '<td style="background-color:#E4E4E4;border-bottom: 0.5px solid #FFFFFF;" ><b style="color:#404040;font-family:Frutiger Bold;">Model No.</b></td><td colspan="8" style="background-color:#D12421;color:white;font-family:Frutiger Bold;border-bottom: 0.5px solid #FFFFFF;">%s</td></tr>' % (
                    ...
                    frappe.log_error(title="Get condition", message=spec[1])
                    data += '</table><p style="page-break-before: always;"></p>'
                    data += '<table class="table-condensed specifictd" style="width:100%">'
                    data += '<tr><td style="background-color:#D12421;font-family:Frutiger Bold;" rowspan="2"><svg height="29" width="10"><text font-size="8px" fill="white" transform="translate(10,28) rotate(-90)">MODEL</text></svg></td>'
                    data += '<td style="background-color:#E4E4E4;border-bottom: 0.5px solid #FFFFFF;" ><b style="color:#404040;font-family:Frutiger Bold;">Model No.</b></td><td colspan="8" style="background-color:#D12421;color:white;font-family:Frutiger Bold;border-bottom: 0.5px solid #FFFFFF;">%s</td></tr>' % (
...
def get_order_info_test(doc):
    data = ''
    data += '<tr><td  style = background-color:#D12421><b style="color:white;">Part Number</p></b></td><td  style = background-color:#D12421><b style="color:white">Description</b></td> <td style="white-space: nowrap;background-color:#D12421"><b style="color:white">Standard Quantity</b></td></tr><tr>'
    for d in doc.ds_order:
        if d.part_number == "br":
            data += '</tr></table><br><table><tr>'
        else:
            data += '<td  style="font-family:Frutiger-Light;" >%s</td><td  style="overflow-wrap:break-word;font-family:Frutiger-Light;">%s</td> <td style="font-family:Frutiger-Light;word-wrap: break-all;">%s</td></tr>' % (
                d.part_number or "" , d.description or "" , d.standard_quantity or "")
    return data
...
def get_pack_info(doc):
    data = ''
    data += '<tr><td colspan="2"><b style="color:#505050">Part Number</b></td><td colspan="3"><b style="color:#505050">Packing Mode</b></td><td colspan="3"><b style="color:#505050">Gross weight(Kg)</b></td><td colspan="3"><b style="color:#505050">Dimension(mm)</b></td></tr><tr>'
