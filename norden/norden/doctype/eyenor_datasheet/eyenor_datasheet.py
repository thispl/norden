...
def datasheet_api():
    ...
    "overview": "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris efficitur tristique leo, mollis imperdiet lectus molestie id. Curabitur tincidunt leo dictum, fringilla dui vitae, fringilla quam.",
    "specification": "Vivamus arcu ex, posuere quis nulla scelerisque, blandit placerat orci. Sed eget ante feugiat, ornare risus dignissim, dignissim nisi. Donec eu odio diam. ",
    "ordering_information": "Morbi at volutpat mauris, ut euismod velit. Nullam posuere, massa nec volutpat porta, mauris quam ullamcorper urna, vel porta enim odio quis tortor. Sed congue ex ut justo blandit malesuada.",
    ...
    "category_id": 15,
    "default_part_number": "3119-31004GBHJNM",
    "image": "https://samplewebsite.com/image-photo/photo.jpg",
