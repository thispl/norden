...
# @frappe.whitelist()
# def get_pdf(html, draft=None,options=None, output: PdfWriter | None = None):
#     frappe.log_error(title=str(draft))
...
#             pdf.setFont("Times-Roman", 120)
#             pdf.rotate(45)
#             pdf.drawCentredString(450, 80, "PREVIEW")
#             pdf.save()
#             packet.seek(0)
...
# def download_pdf(doctype, name, format=None, doc=None, no_letterhead=0,draft=None):
#     html = frappe.get_print(doctype, name, format, doc=doc, no_letterhead=no_letterhead)
#     frappe.local.response.filename = "{name}.pdf".format(name=name.replace(" ", "-").replace("/", "-"))
#     frappe.local.response.filecontent = get_pdf(html,draft=draft)
